...
function the7_update_9140_simple_posts_widget() {
	...
	The7\Inc\Mods\ThemeUpdate\Migrations\v9_14_0\Simple_Posts_Widget_Migration::migrate();
...
function the7_update_9140_simple_posts_carousel_widget() {
	...
	require_once PRESSCORE_MODS_DIR . '/theme-update/migrations/v9_14_0/simple-posts-carousel-widget-migration.php';

	The7\Inc\Mods\ThemeUpdate\Migrations\v9_14_0\Simple_Posts_Carousel_Widget_Migration::migrate();
...
function the7_update_9140_simple_products_widget() {
	...
	require_once PRESSCORE_MODS_DIR . '/theme-update/migrations/v9_14_0/simple-products-widget-migration.php';

	The7\Inc\Mods\ThemeUpdate\Migrations\v9_14_0\Simple_Products_Widget_Migration::migrate();
...
function the7_update_9140_simple_products_carousel_widget() {
	...
	require_once PRESSCORE_MODS_DIR . '/theme-update/migrations/v9_14_0/simple-products-carousel-widget-migration.php';

	The7\Inc\Mods\ThemeUpdate\Migrations\v9_14_0\Simple_Products_Carousel_Widget_Migration::migrate();
...
function the7_update_9140_simple_product_category_widget() {
	...
	require_once PRESSCORE_MODS_DIR . '/theme-update/migrations/v9_14_0/simple-product-category-widget-migration.php';

	The7\Inc\Mods\ThemeUpdate\Migrations\v9_14_0\Simple_Product_Category_Widget_Migration::migrate();
...
function the7_update_9140_simple_product_category_carousel_widget() {
	...
	require_once PRESSCORE_MODS_DIR . '/theme-update/migrations/v9_14_0/simple-product-category-carousel-widget-migration.php';

	The7\Inc\Mods\ThemeUpdate\Migrations\v9_14_0\Simple_Product_Category_Carousel_Widget_Migration::migrate();
