...
use The7\Elementor\Modules\The7_Extend_Widgets_Buttons;
use The7\Elementor\Modules\The7_Extend_Popup;
...
class The7_Elementor_Widgets {
	...
	public function load_dependencies() {
		...
		require_once __DIR__ . '/style/filter-style.php';
		require_once __DIR__ . '/style/pagination-style.php';
		require_once __DIR__ . '/style/woocommerce/filter-style.php';
...
//			$init_widgets['woocommerce/products-taxonomy-filter']  = ['position' => 'before' ];
			...
			if ( array_key_exists( 'product-post', $document_types ) ) {
				$sorted_wc_widgets = [
					...
					'Product_Images',
					'class-the7-elementor-elements-woocommerce-product-additional-information',
					'Product_Additional_Information',
					'class-the7-elementor-elements-woocommerce-product-navigation',
					'class-the7-elementor-woocommerce-product-price',
					'class-the7-elementor-woocommerce-simple-products',
					'class-the7-elementor-woocommerce-simple-products-carousel',
					'class-the7-elementor-woocommerce-filter-attribute',
					'class-the7-elementor-woocommerce-filter-active',
					'class-the7-elementor-woocommerce-product-reviews',
