...
use The7\Adapters\Elementor\Style\Pagination_Style;
	...
	protected function _register_controls() {
		...
		$this->template( Button::class )->add_style_controls(
			...
			[
				...
				'gap_above_button' => [
					'label'     => __( 'Spacing Below Button', 'the7mk2' ),
					'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .project-links-container a > svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .project-links-container a > svg, {{WRAPPER}} .project-links-container a > svg path'             => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .project-links-container a:hover > svg, {{WRAPPER}} .project-links-container a:hover > svg path' => 'fill: {{VALUE}};',
				],
			]
		);
