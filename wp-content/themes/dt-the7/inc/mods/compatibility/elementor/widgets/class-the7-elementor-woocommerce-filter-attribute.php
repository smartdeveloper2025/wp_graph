...
use The7\Adapters\Elementor\Pro\WoocommerceSupport\WC_Widget_Nav;
use The7\Adapters\Elementor\The7_Elementor_Widget_Base;
use WC_Query;

defined( 'ABSPATH' ) || exit;

class The7_Elementor_Woocommerce_Filter_Attribute extends The7_Elementor_Widget_Base {
	...
	protected function add_attributes_content_controls() {
		...
		$this->add_responsive_control( 'box_row_space', [
		...
		$this->add_responsive_control( 'box_column_space', [
		...
		$this->add_responsive_control( 'navigation_max_height', [
	...
	protected function add_title_styles_controls() {
		...
		$this->add_responsive_control( 'title_arrow_size', [
	...
	protected function add_filter_indicator_styles_controls() {
		...
		$this->add_responsive_control( 'filter_indicator_icon_size', [
		...
		$this->add_responsive_control( 'filter_indicator_space', [
			'label'     => __( 'Gap', 'the7mk2' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => [
				'px' => [
	...
	protected function add_item_count_styles_controls() {
		...
		$this->add_responsive_control( 'item_count_space', [
			'label'     => __( 'Gap', 'the7mk2' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => [
				'px' => [
	...
	protected function add_more_button_styles_controls() {
		...
		$this->add_responsive_control( 'more_button_space', [
			'label'     => __( 'Gap', 'the7mk2' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => [
				'px' => [
