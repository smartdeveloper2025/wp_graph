...
/**
 * Class The7_Elementor_Elements_Woocommerce_Product_Navigation
 *
 * @package The7\Adapters\Elementor\Widgets
 */
class The7_Elementor_Elements_Woocommerce_Product_Navigation extends The7_Elementor_Widget_Base {
	...
	public function get_product_object( $in_same_term, $excluded_terms = '', $previous = true, $taxonomy ) {
