	...
	protected function add_meta_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector'       => '{{WRAPPER}} .the7-simple-posts .entry-meta, {{WRAPPER}} .the7-simple-posts .entry-meta a, {{WRAPPER}} .the7-simple-posts .entry-meta span, {{WRAPPER}} .the7-simple-posts .entry-meta a *',
			]
		);
