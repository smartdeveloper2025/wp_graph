...
use The7\Adapters\Elementor\Style\Posts_Masonry_Style;
	...
	protected function add_title_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .post-entry-content .heading, {{WRAPPER}} .post-entry-content .heading *',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .post-entry-content .post-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .post-entry-content .post-title:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} a.post.wrapper:hover .post-entry-content .post-title' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function add_meta_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector'       => '{{WRAPPER}} .entry-meta, {{WRAPPER}} .entry-meta a, {{WRAPPER}} .entry-meta span, {{WRAPPER}} .entry-meta a *',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .entry-meta a, {{WRAPPER}} .entry-meta a *, {{WRAPPER}} .entry-meta span' => 'color: {{VALUE}}',
