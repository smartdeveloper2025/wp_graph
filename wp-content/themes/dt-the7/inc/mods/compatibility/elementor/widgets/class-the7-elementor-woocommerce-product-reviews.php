...
class The7_Elementor_Woocommerce_Product_Reviews extends The7_Elementor_Widget_Base {
	...
	protected function add_layout_controls() {
		...
		$this->add_responsive_control( 'review_column_gap', [
	...
	protected function add_comments_style_controls() {
		...
		$this->add_responsive_control( 'comments_date_spacing', [
		...
		$this->add_responsive_control( 'comments_text_spacing', [
		...
		$this->add_responsive_control( 'comments_box_text_padding', [
		...
		$this->add_responsive_control( 'comments_avatar_size', [
			'label'      => __( 'Size', 'the7mk2' ),
			'type'       => Controls_Manager::SLIDER,
			'default'    => [
				'unit' => 'px',
	...
	protected function add_rating_style_controls() {
		...
		$this->add_responsive_control( 'rating_form_size', [
			'label'      => __( 'Size', 'the7mk2' ),
			'type'       => Controls_Manager::SLIDER,
			'default'    => [
				'unit' => 'px',
		...
		$this->add_responsive_control( 'rating_comment_size', [
			'label'      => __( 'Size', 'the7mk2' ),
			'type'       => Controls_Manager::SLIDER,
			'default'    => [
				'unit' => 'px',
