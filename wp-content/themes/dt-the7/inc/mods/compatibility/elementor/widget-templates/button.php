...
namespace The7\Adapters\Elementor\Widget_Templates;
 ...
 * Class Button
 *
 * @package The7\Adapters\Elementor\Widget_Templates
 */
class Button extends Abstract_Template {
	...
	public function add_style_controls( $icon_controls = self::ICON_MANAGER, $condition = [], $override = [] ) {
		...
		$fields = [
			...
			'button_icon_size'     => [
				...
				'selectors'  => [
					'{{WRAPPER}} .box-button i'   => 'font-size: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .box-button svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}',
				],
					...
					'tab_button_normal' => [
						...
						'fields' => [
							...
							'button_background'   => [
								...
								'selector'       => '{{WRAPPER}} .box-button { transition: none;} {{WRAPPER}} .box-button,  {{WRAPPER}} .box-button:hover, {{WRAPPER}} .box-hover:hover .box-button',
								'fields_options' => [
									'background' => [
										'default' => 'classic',
									],
	...
	public function is_icon_visible() {
		return ! empty( $this->get_settings( 'button_icon' ) );
	}
