...
class The7_Content_Importer extends WP_Import {
	...
	public function import_batch( $file, $batch, $fetch_attachments = true ) {
		...
		// Allow to import svg files, assuming that data from the demo content is safe.
		add_filter(
			'upload_mimes',
			function ( $mimes ) {
	...
	function import( $file ) {
		...
		set_transient( 'the7_import_log', $log, WEEK_IN_SECONDS );
	}
