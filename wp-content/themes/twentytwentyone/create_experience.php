...
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/template-style.css" type="text/css" />
	...
	<div id="content" class="content" role="main">
        <div class="container py-5">
            <div class="row mx-0">
                <h4 class="section-link"><a href="">Experiences</a></h4>
                <div class="col-12">
            ...
            <div class="row mb-5">
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <input type="text" placeholder="Name Your Creation" class="form-control creation_input">
                </div>
                    ...
                    <form method="post">
                        <div class="row m-0">
                            <div class="col-12">
                                ...
                                <input type="text" placeholder="Name of Experience" class="form-control creation_input">
                            </div>
                        </div>
