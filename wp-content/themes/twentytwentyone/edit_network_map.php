            ...
            <div class="row mx-0">
                ...
                <div class="col-12 p-0">
                    <div class="d-flex justify-content-between">
                        <p class="form-text">My Professional Network</p>
                        <p class="form-text">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 p-0">
                        <div class="row m-0">
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                ...
                                <p class="form-text pl-3">Malika singh</p>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <label><i class="fas fa-circle"></i> Orgnization</label>
                                <p class="form-text pl-3">Forest Ventures</p>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <label><i class="fas fa-circle"></i> Position</label>
                                <p class="form-text pl-3">Investment Analyst</p>
                            </div>
                        </div>
                            ...
                            <div class="experience_row_box">
                                ...
                                <div class="form-group pt-0 m-0">
                                    <ul class="nav flex-column creation_list">
                                        <li class="nav-item"><i class="fas fa-circle"></i> Position investor in Knomad</li>
