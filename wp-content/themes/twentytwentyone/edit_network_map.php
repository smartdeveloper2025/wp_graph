<?php
/**
 * Template Name: Edit Network Map
 *
 * Edit Network Map template.
 *
 * @since   1.0.0
 *
            ...
            <!--<form method="post" id="topic_creation" action="" >-->
                <div class="row mb-5">					
						<div class="col-lg-4 col-md-4 col-sm-12">
							...
							<input type="text" placeholder="Name your network map" onblur="net_main_creation()"  id="net_name" name="net_name" value="<?php echo $creation_data['name']; ?>" class="form-control creation_input">
							<label for="net_desc">Description</label>
							<textarea name="net_desc" id="net_desc" onblur="net_main_creation()" class="form-control creation_input" ><?php echo $creation_data['description']; ?></textarea>
							<p>
								[you can use this space to describe the purpose of this creation]
							</p>
							<input type="hidden" name="hdn_net_creation_id" id="hdn_net_creation_id" value="<?php echo $creation_data['id']; ?>" />
							</form>
						</div>
		                        ...
		                        <ul class="nav list_itms">
		                            <li class="nav-item pr-1">
										<div id="cp-component1" class="input-group">
										  <input type="text" value="<?php echo $creation_data['user_color'] ? $creation_data['user_color'] : NT_CRE_USER; ?>" onchange="node_colors()" name="topic_color" id="topic_color" class="form-control" />
		                            ...
		                            <li class="nav-item px-1">
										<div id="cp-component2" class="input-group">
										  <input type="text" value="<?php echo $subcreation_data[0]['node_color'] ? $subcreation_data[0]['node_color'] : NT_CRE_SUB; ?>" onchange="node_colors()" name="sub_topic_color" id="sub_topic_color" class="form-control"  />
										  <span class="input-group-addon"><i></i></span>
										</div>
										<b>Contacts</b>
									</li>
									<li class="nav-item px-1">
										<div id="cp-component3" class="input-group">
										  <input type="text" value="<?php echo $subcreation_data[0]['field_2_color'] ? $subcreation_data[0]['field_2_color'] : NT_CRE_ORG; ?>" onchange="node_colors()" name="source_color"  id="source_color" class="form-control"  />
										  <span class="input-group-addon"><i></i></span>
										</div>
										<b>Organization</b>
									</li>
									<li class="nav-item px-1">
										<div id="cp-component4" class="input-group">
										  <input type="text" value="<?php echo $subcreation_data[0]['field_3_color'] ? $subcreation_data[0]['field_3_color'] : NT_CRE_POS; ?>" onchange="node_colors()" name="key_color"  id="key_color" class="form-control"  />
										  <span class="input-group-addon"><i></i></span>
										</div>
										<b>Position</b>
									</li>
									<li class="nav-item px-1">
										<div id="cp-component5" class="input-group">
										  <input type="text" value="<?php echo $subcreation_data[0]['details'][0]['lft_node_color'] ? $subcreation_data[0]['details'][0]['lft_node_color'] : NT_CRE_LF; ?>" onchange="node_colors()" name="they_help_color"  id="they_help_color" class="form-control"  />
										  <span class="input-group-addon"><i></i></span>
										</div>
									...
									<li class="nav-item px-1" style="display:none;">
										<div id="cp-component6" class="input-group">
										  <input type="text" value="<?php echo $subcreation_data[0]['details'][0]['rt_node_color'] ? $subcreation_data[0]['details'][0]['rt_node_color'] : NT_CRE_RT; ?>" onchange="node_colors()" name="i_help_color"  id="i_help_color" class="form-control"  />
										  <span class="input-group-addon"><i></i></span>
										</div>
										<b>How can I help?</b>
									</li>									
			...
			<input type="hidden" name="clone_counter" id="clone_counter" value="<?php echo count($subcreation_data); ?>" />
                <div class="row chart__div">
					...
					<?php foreach($subcreation_data as $sub_key => $sub_data){ $sub_key++;  ?>
							...
							<h4 class="section-link mb-2"><a href="">Contact: <?php echo $sub_key; ?></a></h4>
							<form method="post" id="sub_creation_frm_<?php echo $sub_key; ?>" action="" >
							<!-- <div class="col-lg-7 col-md-7 col-sm-7 p-0"> -->
								<div class="col-12 p-0">
									<div class="row">
										<input type="hidden" name="hdn_net_sub_creation_id" id="hdn_net_sub_creation_id_<?php echo $sub_key; ?>" value="<?php echo $sub_data['id']; ?>" />
