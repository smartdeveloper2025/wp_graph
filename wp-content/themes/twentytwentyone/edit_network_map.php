									...
									<div class="col-12">
										...
										<table class="creation_table table_bordered network__table">
											...
											<?php } ?>
												...
												<tr><td><div class="d-flex align-items-center">
															<i class="fas fa-circle" aria-hidden="true"></i>
															<input type="text" name="tag_val[0][left]" placeholder="What benefit can this person provide?[e.g. referral, resume tips]" class="form-control creation_input " onblur="sub_net_creation(<?php echo $sub_key; ?>)" onclick="clone_skills(this,<?php echo $sub_key; ?>)" >
														</div>
													</td>
													<td>
														<div class="d-flex align-items-center">
															<i class="fas fa-circle" aria-hidden="true"></i>
															<input type="text" name="tag_val[0][right]" onblur="sub_net_creation(<?php echo $sub_key; ?>)" onclick="tag_call(this)" placeholder="What benefit can you provide this person?" class="form-control tag_cls creation_input" >
														</div>
													</td>
												</tr>
...
function html_clone(){
	...
	var html = '';
	html += '<div class="row">';
    html += '<div class="col-12"><h4 class="section-link mb-2"><a href="">Contact: ' + clone_counter + '</a></h4></div>';
	html += '<form method="post" id="sub_creation_frm_' + clone_counter + '" action="" >';
	html += '<div class="col-lg-7 col-md-7 col-sm-12 p-0">';
	html += '<div class="col-12"><div class="row m-0">';
	...
	html += '<div class="col-12"><label>Notes</label><input type="text" name="sub_net_notes" onblur="sub_net_creation(' + clone_counter + ')" placeholder="Type Here" class="form-control creation_input"></div></div></div></form></div>';
